# cisshgo
Simple, small, fast, concurrent SSH server to emulate network equipment (i.e. Cisco IOS) for testing purposes.<br>
This can be used for Cisco Devnet training when real devices aren't available.
